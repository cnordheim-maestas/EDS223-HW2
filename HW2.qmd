...
## for fun, let's mix it up, 2 numeric variables and grade grouping
means %>%  
  ggplot(aes(x = grade, y = pct_le, color = pm25_mean)) + # color by grade for fun
  geom_point(size = 10) + 
  labs(
    x = "HOLC Grade", # grade on x
